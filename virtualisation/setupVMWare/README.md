...
* A computer running Windows 8 or newer, or a computer running Linux (ie. Ubuntu, Red Hat, CentOS, openSUSE, etc.)
	...
	* On Windows, you can check here: <a href="ms-settings:about?activationSource=SMC-Article-15056" target="_blank" role="button" class="ocpExternalLink supLinkButton" ms.cmpgrp="content" ms.pgarea="Body">Open About settings</a> (This link will open in your Windows Settings! If you do not want this, you can go to Settings/System/About.
